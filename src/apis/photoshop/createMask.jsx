    ...
    return(
        <Flex direction={'column'} gap={10}>
            <Flex direction={'column'}>
                <Heading level={1}>Create Mask</Heading>
                <Text>
                Generates a mask PNG from the input image. To know more about this feature refer <Link href="https://developer.adobe.com/photoshop/photoshop-api-docs/features/#image-mask">Image Mask</Link>
                </Text>
                <Heading level={3}>Instructions:</Heading>
                <Text>In this example, we are removing the background via the image mask APIs are powered by Adobe’s AI Technology and Photoshop.</Text>
