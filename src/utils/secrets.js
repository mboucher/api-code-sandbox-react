...
export const REACT_APP_EXPRESS_SDK_CDN = process.env.REACT_APP_EXPRESS_SDK_CDN;
export const REACT_APP_EXPRESS_CLIENT_ID = process.env.REACT_APP_EXPRESS_CLIENT_ID;
export const REACT_APP_EXPRESS_APP_NAME = process.env.REACT_APP_EXPRESS_APP_NAME;
